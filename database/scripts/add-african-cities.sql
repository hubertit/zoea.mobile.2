...
BEGIN
    ...
    -- ============================================
    -- KENYA CITIES (Delete wrong cities first)
    -- ============================================
    -- Delete Rwandan cities from Kenya
    DELETE FROM cities WHERE country_id = kenya_id AND slug IN ('kigali', 'musanze', 'rubavu', 'rusizi', 'karongi');
