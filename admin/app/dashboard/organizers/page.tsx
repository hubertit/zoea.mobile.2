...
import Icon, { faSearch, faTimes, faCalendar, faUser, faCheckCircle, faTimesCircle } from '@/app/components/Icon';
    ...
    const fetchOrganizers = async () => {
      ...
      try {
        const params: any = {
          page,
          limit: pageSize,
          role: 'event_organizer', // Filter by organizer role
        };
        ...
        if (search.trim()) {
          ...
          filteredData = filteredData.filter((organizer) => {
            const name = organizer.fullName?.toLowerCase() || '';
      ...
      render: (_: any, row: User) => (
        <div className="flex items-center gap-3">
          <div className="w-10 h-10 bg-purple-100 rounded-full flex items-center justify-center">
            <Icon icon={faCalendar} className="text-purple-600" size="sm" />
          </div>
          <div>
    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between flex-wrap gap-4">
        <div>
          ...
          <p className="text-gray-600 mt-1">Manage event organizers and their profiles</p>
        </div>
      </div>
