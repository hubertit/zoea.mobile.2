...
export default function EditVenuePage() {
  ...
  useEffect(() => {
    const venue = mockVenues.find(v => v.venue_id === parseInt(venueId));
    if (venue) {
      setFormData({
        venue_name: venue.venue_name,
        venue_about: venue.venue_about,
        venue_address: venue.venue_address,
        venue_coordinates: venue.venue_coordinates,
        venue_price: venue.venue_price.toString(),
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    setTimeout(() => {
      console.log('Updating venue:', venueId, formData);
      setLoading(false);
