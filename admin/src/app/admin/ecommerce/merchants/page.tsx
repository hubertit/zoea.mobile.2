...
import Icon, { faStore, faDollarSign, faShoppingCart, faChartLine } from '../../../components/Icon';
  ...
  return (
    <div>
      <div className="mb-8">
        ...
        <p className="text-gray-600">Manage and view all e-commerce merchants</p>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-6">
        ...
        <ChartWrapper title="Merchant Status Distribution" loading={loading}>
          <PieChart
            data={[
